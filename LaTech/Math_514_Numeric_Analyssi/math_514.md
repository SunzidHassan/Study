...
$h=x_1-x_0=1.2-1.1=0.1$

Three-point formula:  
$f'(x_0)=\frac{1}{2h}[-3f(x_0)+4f(x_0+h)-f(x_0+2h)]$

$f'(1.1)=\frac{1}{2(0.1)}[-3(9.025013)+4f(11.02318)-13.46374]=17.769705$

Using the three-point midpoint formula:  
$f'(1.2)=\frac{1}{2(0.1)}[f(1.3)-f(1.1)]=22.193635$  
$f'(1.3)=\frac{1}{2(0.1)}[f(1.4)-f(1.2)]=27.107350$  
$f'(1.4)=\frac{1}{2(0.1)}[-3f(1.4)+4f(1.3)-f(1.2)]=32.5085$  
...
Using $f'(x_0)=N_1(h)-\frac{h^2}{6}f'''(x_0)-\frac{h^4}{120}f^{(5)}(x_0)$  
$N_1(h)=\frac{1}{2h}[f(x_0+h)-f(x_0-h)]$  
$N_1(0.4)=\frac{1}{2(0.4)}[\ln(1.4)-\ln(0.6)]=1.0591223$  
$N_1(0.2)=\frac{1}{0.4}[\ln(1.2)-\ln(0.8)]=1.0136627$  
$N_1(0.1)=\frac{1}{0.2}[\ln(1.1)-\ln(0.9)]=1.00335348$

$N_2(h)=N_1(\frac{h}{2})+\frac{1}{3}[N_1(\frac{h}{2})-N_1(h)]$  
$N_2(0.4)=1.0136627+(1/3)[1.0136627-1.0591223]=0.998509571$  
$N_2(h/2)=N_2(0.2)=N_1(\frac{h}{4})+\frac{1}{3}[N_1(\frac{h}{4})-N_1(h/2)]=0.999917056$  
$N_3(h)=N_3(0.4)=\frac{1}{15}[16N_2(h/2)-N_2(h)]=1.000010901$
...
$R_{4,1}=\frac{1.5-1}{2^4}\left[1^2\ln{1}+2\times[1.0625^2\ln{1.0625}+1.125^2\ln{1.125}+1.3125^2\ln{1.3125}+1.25^2\ln{1.25}+1.3125^2\ln{1.3125}+1.375^2\ln{1.375}+1.4375^2\ln{1.4375}]+1.5^2\ln{1.5}\right]=0.192818$  
...
$a=1$, $b=1.5$  
$x=\frac{1}{2}[(1.5-1)t+1+1.5]=0.25t+1.25$  
$dx=0.25dt$  
$\int_{1}^{1.5}{x^2\ln{x}dx}=0.25[(0.25(1\sqrt{3})+1.25)^2\ln(0.25(1\sqrt{3})+1.25)+(0.25(-1\sqrt{3})+1.25)^2\ln(0.25(-1\sqrt{3})+1.25)]=1.922687063$