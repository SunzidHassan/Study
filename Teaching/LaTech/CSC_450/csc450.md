...
- [Table of Contents](#table-of-contents)
  ...
  - [Chapter 5: The Network Layer: Control Plane](#chapter-5-the-network-layer-control-plane)
    - [Dr. Tahat's lectuer](#dr-tahats-lectuer)
...
- Upper layer protocol: Transport layer protocol (6: TCP, 17: UDP).
...
IP address is associated with an interface (link boundary), rather than device.
Each address is 4 bytes (32 bits), written in decimal (or translated in binary octets) seperated by period.
...
2. Choose nex pos (choose an unexplored node with min cost)
