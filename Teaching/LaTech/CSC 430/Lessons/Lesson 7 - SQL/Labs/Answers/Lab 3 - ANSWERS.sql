...
/*1. Write a trigger to create a default department location in Bellaire every time a new department is inserted into the database.*/
DELIMITER $$
...
BEGIN
    ...
    IF NEW.salary > supervisor_salary * 1.5 THEN
        SIGNAL SQLSTATE '45000'
        SET MESSAGE_TEXT = 'Supervisee salary is much higher than supervisor salary';
    END IF;
END $$
DELIMITER ;
...
SELECT emp.fname, emp.lname, emp.ssn, emp.salary, dept.dname
