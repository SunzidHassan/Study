...
drop database if exists StudentdbW22; /* Replace <Studentdb> with a database name of your choice*/

create database StudentdbW22; /* Replace <Studentdb> with the database name of your choice*/

use StudentdbW22; /* Replace <Studentdb> with the database name of your choice*/
